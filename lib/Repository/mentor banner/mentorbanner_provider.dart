...
import 'package:course/Repository/mentor%20banner/mentorbanner_service.dart';
...
class MentorBannerProvider extends ChangeNotifier {
  ...
  final MentorBannerService _service = MentorBannerService();
  ...
  Future<void> fetchMentorBanners() async {
    ...
    try {
      final data = await _service.getMentorBanners();
      _banners = data;
